        ...
        <channel-uploads inline-template>
            ...
            <div class="col-md-8">
                <div class="card p-3 d-flex justify-content-center align-items-center" v-if="!selected">
                    ...
                    <input type="file" name="" id="video-files" ref="videos" style="display:none" @change="upload">
                    <svg onclick="document.getElementById('video-files').click()" width="70px" height="70px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 461 461">
