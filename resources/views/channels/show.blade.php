    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="update-channel-form" method="post" action="{{ route('channels.update', $channel->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group row justify-content-center">
                            <div class="channel-avatar">
                                <div onclick="document.getElementById('image').click()" class="channel-avatar-overlay">
                                    ...
                                    <img src="{{ $channel->media()->first()->getFullUrl('thumb') }}" alt="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" class="form-control" type="text" name="" rows="3">{{ $channel->description }}</textarea>
                        </div>
